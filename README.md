...
1. **질문하면 유튜브 댓글을 모아 옵니다.** 질문을 치거나 미리 준비된 질문 버튼을 누르면, 유튜브 공식 API로 관련 영상의 댓글을 가져옵니다.
2. **똑같거나 비슷한 댓글은 하나로 합칩니다.** 같은 말, 같은 영상 안에서 반복된 말은 빼고 "진짜 몇 명이 겪었나"만 셉니다.
3. **불만보다 행동을 더 크게 봅니다.** 그냥 "짜증나요"보다 "우회했다, 다른 걸 찾았다, 그만뒀다, 돈 썼다" 같은 댓글이 많은 문제를 위로 올립니다.
4. **왜 그 순위인지 원문까지 보여줍니다.** 순위가 바뀌는 과정을 애니메이션으로 보여주고, 화면의 숫자를 누르면 근거가 된 댓글 원문을 볼 수 있습니다.
